...
/*   Updated: 2019/12/02 12:21:37 by ozakkare         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ft_printf.h"

void	initialiseargsu(t_args *args, t_flag *flag)
{
	args->dcm = NULL;
	args->b = 0;
	args->n = 0;
	...
	args->z = 0;
	args->forzero = 0;
	if ((ft_atoi(args->dcm = ft_itoau((unsigned int)flag->arg))) < 0)
	{
		args->n = 1;
...
void	casesu(t_args *args, t_flag *flag)
{
